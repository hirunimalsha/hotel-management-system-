...
namespace WindowsFormsApp1
{
    public partial class BillEditor : Form
    {
        ...
        private void CustomerNameByRoomNumber(string roomNumber)
        {
            ...
            lbl_CustomerName.Text = $"{guest.Designation}. {guest.FirstName} {guest.LastName}";
        }
        ...
        private void MenuItemByItemNumber(string item_number)
        {
            ...
            lbl_ItemNumber.Text = menuItem.ItemNumber;
            lbl_ItemName.Text = menuItem.ItemName;
            lbl_ItemPrice.Text = menuItem.ItemPrice.ToString();
            TxtQuantityChanged();
        }
